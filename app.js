...
const ALLOWED_FIELDS = {
  ...
  "di-texas-oca-court-dispositions-criminal": new Set(["cause_number","recordid","county","publisher","court_id_number","court_name","court_type","primary_case_category","judicial_council_case_category","jcit_case_type","judicial_council_offense_type","local_case_type","case_initial_filing_date","criminal_disposition_detail","disposition_date","party_age_at_time_of_offense","party_race","party_ethnicity","party_sex","party_zip_code","party_indigency_status","attorney_type","attorney_name","state_bar_card_number","offense_date","arrest_date","death_penalty_flag","disposition_statute","disposition_statute_citation","disposition_offense_code","disposition_offense_description","level_and_degree_of_disposed_offense","disposition_charge_modifier","disposition_other_enhancements","court_offense_literal","domestic_violence_finding","victim_age","deadly_weapon_finding","charge_disposition_date","plea_type","plea_date","case_judicial_officer_name","case_judicial_officer_type","sentence_type","juvenile_disposition_type","sentence_length","sentencing_date","concurrent_consecutive_sentence","monetary_penalty_amount_court_costs","monetary_penalty_amount_fines","monetary_penalty_amount_restitution","name_of_party","update_date","most_severe_charge"]),
  "di-texas-oca-court-dispositions-non-criminal": new Set(["cause_number","recordid","county","publisher","court_id_number","court_name","court_type","primary_case_category","judicial_council_case_category","jcit_case_type","local_case_type","case_initial_filing_date","non_criminal_disposition_detail","disposition_date","case_judicial_officer_name","case_judicial_officer_type","update_date"]),
  "di-texas-oca-court-party": new Set(["cause_number","recordid","county","publisher","court_id_number","court_name","court_type","primary_case_category","judicial_council_case_category","jcit_case_type","judicial_council_offense_type","local_case_type","case_initial_filing_date","disposition_date","party_age_at_time_of_offense","party_race","party_ethnicity","party_sex","party_zip_code","party_indigency_status","case_judicial_officer_name","case_judicial_officer_type","name_of_party","party_type","update_date"]),
